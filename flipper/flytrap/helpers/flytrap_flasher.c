#include "flytrap_flasher.h"
#include "flytrap_esp_port.h"
...
static int parse_manifest(const char* manifest_path, const char* text, FlashImage* images, int max) {
...
bool flytrap_flasher_run(
    ...
    // Take the serial line from the portal worker, at the flash baud.
