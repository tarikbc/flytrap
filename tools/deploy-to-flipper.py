...
def main():
    ...
    try:
        ...
        # The firmware bundle ships inside the fap (fap_file_assets) and extracts to
        # apps_assets on launch, so we only push the fap + user portals here. The
        # app installs/updates the ESP from that bundled copy — no SD firmware dir.
